...
@register_op
class ArrangeRRPN(BaseOperator):
    """
    Transform dict to tuple format needed for training.
    """

    def __init__(self):
        super(ArrangeRRPN, self).__init__()
    ...
    def __call__(self, sample, context=None):
        ...
        im_info = sample['im_info']
        im_id = sample['im_id']
        outs = (im, gt_bbox, gt_class, is_crowd, im_info, im_id)

        return outs


@register_op
class ArrangeEvalRRPN(BaseOperator):
    """
    Transform dict to tuple format needed for evaluation.
    """

    def __init__(self):
        super(ArrangeEvalRRPN, self).__init__()
    ...
    def __call__(self, sample, context=None):
        ...
        im_info = sample['im_info']
        im_id = sample['im_id']
        is_difficult = sample['is_difficult']
        outs = (im, gt_bbox, gt_class, is_crowd, im_info, im_id, is_difficult)
        return outs


@register_op
class ArrangeTestRRPN(BaseOperator):
    """
    Transform dict to tuple format needed for inference.
    """

    def __init__(self):
        super(ArrangeTestRRPN, self).__init__()
