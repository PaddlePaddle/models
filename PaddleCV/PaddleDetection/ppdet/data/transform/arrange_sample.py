...
@register_op
class ArrangeBlazeFace(BaseOperator):
    """
    Transform dict to tuple format needed for training.
    """

    def __init__(self):
        super(ArrangeBlazeFace, self).__init__()
...
@register_op
class ArrangeTestBlazeFace(BaseOperator):
    """
    Transform dict to tuple format needed for training.
    """

    def __init__(self):
        super(ArrangeTestBlazeFace, self).__init__()
