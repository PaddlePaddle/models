...
public:
  ...
  struct primitive_desc : public handle<mkldnn_primitive_desc_t> {
    ...
    bool operator==(const primitive_desc &other) const {
      return (0 == mkldnn_memory_primitive_desc_equal(get(), other.get()))
                 ? false
                 : true;
    }
...
inline void check_num_parameters(
    const const_mkldnn_primitive_desc_t &aprimitive_desc,
    int n_inputs,
    int n_outputs,
...
struct primitive_desc : public handle<mkldnn_primitive_desc_t> {
  primitive_desc(const_mkldnn_op_desc_t desc,
    ...
    mkldnn_status_t status = mkldnn_primitive_desc_iterator_create_v2(
        &iterator, desc, attr ? attr->get() : nullptr, e.get(), hint_fwd_pd);
  ...
  const char *impl_info_str() const {
    const char *res;
    error::wrap_c_api(
        mkldnn_primitive_desc_query(get(), mkldnn_query_impl_info_str, 0, &res),
  ...
  memory::primitive_desc query_mpd(query what, int idx = 0) const {
    std::vector<query> valid_w{input_pd,
                               output_pd,
                               src_pd,
                               diff_src_pd,
                               weights_pd,
                               ...
                               diff_dst_pd,
                               workspace_pd};
    if (!std::any_of(valid_w.cbegin(), valid_w.cend(), [=](query q) {
          return what == q;
        }))
      throw error(mkldnn_invalid_arguments, "invalid memory query");

    const_mkldnn_primitive_desc_t const_cdesc =
        mkldnn_primitive_desc_query_pd(get(), mkldnn::convert_to_c(what), idx);
...
private:
  ...
  void fetch_impl() {
    ...
    error::wrap_c_api(
        pd != nullptr ? mkldnn_success : mkldnn_runtime_error,
...
struct convolution_forward : public primitive {
  ...
  struct primitive_desc : public mkldnn::primitive_desc {
    ...
    primitive_desc(const desc &desc,
                   const primitive_attr &attr,
                   const engine &e)
  ...
  convolution_forward(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {dst.get()};
    check_num_parameters(aprimitive_desc.get(), 2, 1, "convolution forward");
    error::wrap_c_api(mkldnn_primitive_create(
                          &result, aprimitive_desc.get(), inputs, outputs),
...
struct convolution_backward_data : public primitive {
  ...
  convolution_backward_data(const primitive_desc &aprimitive_desc,
    ...
    check_num_parameters(
        aprimitive_desc.get(), 2, 1, "convolution backward data");
    error::wrap_c_api(mkldnn_primitive_create(
                          &result, aprimitive_desc.get(), inputs, outputs),
...
struct convolution_backward_weights : public primitive {
  ...
  convolution_backward_weights(const primitive_desc &aprimitive_desc,
    ...
    check_num_parameters(
        aprimitive_desc.get(), 2, 2, "convolution backward weights");
    error::wrap_c_api(
  ...
  convolution_backward_weights(const primitive_desc &aprimitive_desc,
    ...
    check_num_parameters(
        aprimitive_desc.get(), 2, 1, "convolution backward weights");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
        "could not create a convolution backward weights primitive");
...
struct deconvolution_forward : public primitive {
  ...
  deconvolution_forward(const primitive_desc &aprimitive_desc,
    ...
    mkldnn_primitive_at_t inputs[] = {src.data, weights.data, bias.data};
    const_mkldnn_primitive_t outputs[] = {dst.get()};
    check_num_parameters(aprimitive_desc.get(), 3, 1, "deconvolution forward");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
  ...
  deconvolution_forward(const primitive_desc &aprimitive_desc,
    ...
    mkldnn_primitive_at_t inputs[] = {src.data, weights.data};
    const_mkldnn_primitive_t outputs[] = {dst.get()};
    check_num_parameters(aprimitive_desc.get(), 2, 1, "deconvolution forward");
    error::wrap_c_api(mkldnn_primitive_create(
                          &result, aprimitive_desc.get(), inputs, outputs),
...
struct deconvolution_backward_data : public primitive {
  struct desc {
    ...
    desc(algorithm aalgorithm,
      ...
      memory::validate_dims(padding_r);
      error::wrap_c_api(
          mkldnn_dilated_deconvolution_backward_data_desc_init(
              &data,
              convert_to_c(aalgorithm),
              &diff_src_desc.data,
              &weights_desc.data,
  ...
  deconvolution_backward_data(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {diff_src.get()};
    check_num_parameters(
        aprimitive_desc.get(), 2, 1, "deconvolution backward data");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
...
struct deconvolution_backward_weights : public primitive {
  ...
  deconvolution_backward_weights(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {diff_weights.get(), diff_bias.get()};
    check_num_parameters(
        aprimitive_desc.get(), 2, 2, "deconvolution backward weights");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
  ...
  deconvolution_backward_weights(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {diff_weights.get()};
    check_num_parameters(
        aprimitive_desc.get(), 2, 1, "deconvolution backward weights");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
        "could not create a deconvolution backward weights primitive");
...
struct softmax_backward : public primitive {
  struct desc {
    mkldnn_softmax_desc_t data;
    desc(const memory::desc &diff_desc,
         const memory::desc &data_desc,
         int softmax_axis) {
      error::wrap_c_api(
          mkldnn_softmax_backward_desc_init(
              &data, &diff_desc.data, &data_desc.data, softmax_axis),
...
struct batch_normalization_forward : public primitive {
  ...
  batch_normalization_forward(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {dst.get()};
    check_num_parameters(
        aprimitive_desc.get(), 4, 1, "batch normalization forward");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
  ...
  batch_normalization_forward(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {dst.get()};
    check_num_parameters(
        aprimitive_desc.get(), 3, 1, "batch normalization forward");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
        "could not create a batch normalization forward primitive");
  ...
  batch_normalization_forward(const primitive_desc &aprimitive_desc,
    ...
    check_num_parameters(
        aprimitive_desc.get(), 2, 3, "batch normalization forward");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
        "could not create a batch normalization forward primitive");
  ...
  batch_normalization_forward(const primitive_desc &aprimitive_desc,
    ...
    check_num_parameters(
        aprimitive_desc.get(), 2, 4, "batch normalization forward");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
        "could not create a batch normalization forward primitive");
  ...
  batch_normalization_forward(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {
        dst.get(), mean.get(), variance.get()};
    check_num_parameters(
        aprimitive_desc.get(), 1, 3, "batch normalization forward");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
        "could not create a batch normalization forward primitive");
  ...
  batch_normalization_forward(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {dst.get()};
    check_num_parameters(
        aprimitive_desc.get(), 2, 1, "batch normalization forward");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
        "could not create a batch normalization forward primitive");
  ...
  batch_normalization_forward(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {dst.get()};
    check_num_parameters(
        aprimitive_desc.get(), 1, 1, "batch normalization forward");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
        "could not create a batch normalization forward primitive");
...
struct batch_normalization_backward : public primitive {
  ...
  batch_normalization_backward(const primitive_desc &aprimitive_desc,
    ...
    check_num_parameters(
        aprimitive_desc.get(), 5, 2, "batch normalization backward");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
  ...
  batch_normalization_backward(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {diff_src.get(), diff_weights.get()};
    check_num_parameters(
        aprimitive_desc.get(), 6, 2, "batch normalization backward");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
        "could not create a batch normalization backward primitive");
  ...
  batch_normalization_backward(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {diff_src.get()};
    check_num_parameters(
        aprimitive_desc.get(), 5, 1, "batch normalization backward");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
        "could not create a batch normalization backward primitive");
  ...
  batch_normalization_backward(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {diff_src.get()};
    check_num_parameters(
        aprimitive_desc.get(), 4, 1, "batch normalization backward");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
        "could not create a batch normalization backward primitive");
...
struct inner_product_forward : public primitive {
  ...
  inner_product_forward(const primitive_desc &aprimitive_desc,
    ...
    mkldnn_primitive_at_t inputs[] = {src.data, weights.data, bias.data};
    const_mkldnn_primitive_t outputs[] = {dst.get()};
    check_num_parameters(aprimitive_desc.get(), 3, 1, "inner product forward");
    error::wrap_c_api(mkldnn_primitive_create(
                          &result, aprimitive_desc.get(), inputs, outputs),
  ...
  inner_product_forward(const primitive_desc &aprimitive_desc,
    ...
    mkldnn_primitive_at_t inputs[] = {src.data, weights.data};
    const_mkldnn_primitive_t outputs[] = {dst.get()};
    check_num_parameters(aprimitive_desc.get(), 2, 1, "inner product forward");
    error::wrap_c_api(mkldnn_primitive_create(
                          &result, aprimitive_desc.get(), inputs, outputs),
                      "could not create a inner product forward primitive");
    reset(result);
...
struct inner_product_backward_data : public primitive {
  ...
  inner_product_backward_data(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {diff_src.get()};
    check_num_parameters(
        aprimitive_desc.get(), 2, 1, "inner product backward data");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
...
struct inner_product_backward_weights : public primitive {
  ...
  inner_product_backward_weights(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {diff_weights.get()};
    check_num_parameters(
        aprimitive_desc.get(), 2, 1, "inner product backward weights");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
  ...
  inner_product_backward_weights(const primitive_desc &aprimitive_desc,
    ...
    const_mkldnn_primitive_t outputs[] = {diff_weights.get(), diff_bias.get()};
    check_num_parameters(
        aprimitive_desc.get(), 2, 2, "inner product backward weights");
    error::wrap_c_api(
        mkldnn_primitive_create(
            &result, aprimitive_desc.get(), inputs, outputs),
        "could not create a inner product backward weights primitive");
