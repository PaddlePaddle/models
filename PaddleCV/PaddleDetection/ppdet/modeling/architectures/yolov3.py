...
class YOLOv3(object):
    ...
    def build(self, mode='train', image_shape=None):
        ...
        if mode == 'train':
            gt_box = fluid.data(
                name='gt_box', shape=[None, 50, 4], dtype='float32')
            gt_label = fluid.data(
                name='gt_label', shape=[None, 50], dtype='int32')
            gt_score = fluid.data(
                name='gt_score', shape=[None, 50], dtype='float32')
            ...
            im_size = fluid.data(name='im_size', shape=[None, 2], dtype='int32')
