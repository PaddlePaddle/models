...
class RRPN(object):
    ...
    __inject__ = [
        'backbone', 'rrpn_head', 'rbbox_assigner', 'rroi_extractor',
        'rbbox_head', 'fpn'
    ]
    ...
    def __init__(self,
                 ...
                 rrpn_head,
                 rroi_extractor,
                 rbbox_head='RBBoxHead',
                 rbbox_assigner='RBBoxAssigner',
                 rpn_only=False,
                 fpn=None):
        super(RRPN, self).__init__()
        self.backbone = backbone
        self.rpn_head = rrpn_head
        self.bbox_assigner = rbbox_assigner
        self.roi_extractor = rroi_extractor
        self.bbox_head = rbbox_head
        self.fpn = fpn
