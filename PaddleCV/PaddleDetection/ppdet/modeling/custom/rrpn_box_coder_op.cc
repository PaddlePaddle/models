...
public:
  void Make() override {
    ...
    //                     "(string, default decode_center_size) "
    //                     "the code type used with the target box")
    //    .SetDefault("decode_center_size")
    //    .InEnum({"decode_center_size"});
...
//    rrpn_box_coder,
//    ops::RRPNBoxCoderKernel<paddle::platform::CPUDeviceContext, float>,
//    ops::RRPNBoxCoderKernel<paddle::platform::CPUDeviceContext, double>);
