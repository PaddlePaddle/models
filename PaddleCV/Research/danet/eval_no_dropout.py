...
# 多尺度测试非常耗时（大概15小时）， DANet101, batch_size=1, 显存需要>8G,
...
from danet_no_dropout_for_test import DANet
...
def eval(args, model_path):
    ...
    with fluid.dygraph.guard():
        ...
        for data in reader():
            ...
            save_png_path = label_path.replace('val', 'DANet101_val').replace('test', 'DANet101_test')
...
if __name__ == '__main__':
    ...
    model_path = 'D:\PyCharm_Workspace\paddle_DANet_last\checkpoint\DANet101_better_model_paddle1.6'
