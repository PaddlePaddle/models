...
class BaseTrainer:
    ...
    def save_checkpoint(self):
        ...
        directory = '{}/{}/{}_ep{:04d}'.format(self._checkpoint_dir, self.settings.project_path, net_type, self.epoch)
    ...
    def load_checkpoint(self, checkpoint=None):
        ...
        if checkpoint is None:
            ...
            checkpoint_list = sorted(glob.glob('{}/{}/{}_ep*'.format(self._checkpoint_dir,
            ...
            checkpoint_path = '{}/{}/{}_ep{:04d}'.format(self._checkpoint_dir, self.settings.project_path,
                                                         net_type, checkpoint)
        ...
        # paddle load state
        state_path = '{}/{}/custom_state.pickle'.format(self._checkpoint_dir, self.settings.project_path)
        current_state = pickle.load(open(os.path.join(state_path, 'custom_state.pickle'), 'rb'))
