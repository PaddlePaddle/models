...
class ValidVOT(SiamFC):
    def __init__(self, dataset_root, dataset_name, params):
        ...
        if dataset_name not in dataset_list:
            raise Exception("ValidVOT's dataset_name can only be one of {}".format(dataset_list))
...
parser.add_argument('--dataset_dir', type=str, default="/paddle/Datasets/VOT2015",
                    help="the path of VOT dataset")
parser.add_argument('--dataset_name', type=str, default="VOT2015",
...
if __name__ == '__main__':
    ...
    for i in range(start_epoch, end_epoch, 2):
        ...
        valid = ValidVOT(dataset_root=args.dataset_dir, dataset_name=args.dataset_name, params=params)
        ...
        if acc > best_acc and failure <= 84:
            best_acc = acc
            best_epoch = i
            print("####Best ACC: {}, Failure: {}, corresponding epoch: {}".format(best_acc, failure, best_epoch))
