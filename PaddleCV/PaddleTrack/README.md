...
在启动训练前，需要设置PaddleTrack使用的数据集路径，以及训练模型保存的路径，这些参数在ltr/admin/local.py中设置。
...
```bash
ln -s PaddleTrack/ltr/Logs/checkpoints/ltr/bbreg/atom_res18_vid_lasot_coco $NETWORK_PATH/bbreg
```
