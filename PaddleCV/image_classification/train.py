...
def train(args):
    ...
    if not args.enable_ce:
        train_reader = paddle.batch(
            reader.train(args.data_dir), batch_size=train_batch_size, drop_last=True)
        test_reader = paddle.batch(reader.val(args.data_dir,args.image_shape), batch_size=test_batch_size)
    else:
