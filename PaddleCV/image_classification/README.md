...
- Note2: Dynamic link library can be called for inference by converting the model and pretrained model into binary models. The conversion can be completed by setting the parameter save_inference to True in infer.py in the process of inference.
