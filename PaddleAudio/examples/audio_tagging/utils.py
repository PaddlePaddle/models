...
__all__ = ['get_logger','save_checkpoint','load_checkpoint','get_labels527'
           ,'random_choice','get_label_name_mapping']
...
def download_assets():
    ...
    urls = ['https://raw.githubusercontent.com/audioset/ontology/master/ontology.json',
