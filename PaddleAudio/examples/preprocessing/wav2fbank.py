...
class FeatureExtractor:
    ...
    def process_wav(self, wav: Union[PathLike, np.ndarray]) -> np.ndarray:
        ...
        x = pa.features.melspectrogram(wav, **self.kwargs)
        return x
...
if __name__ == '__main__':
    ...
    if n_file_per_h5 == -1:
        ...
        group_files = [wav_files[i:i + n_file_per_h5] for i in range(n_group)]
        group_names = [names[i:i + n_file_per_h5] for i in range(n_group)]
