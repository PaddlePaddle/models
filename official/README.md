...
<table>
    ...
    <tr>
        <td>1</td>
        <td>PPLCNet_x0_25</td>
        <td><a href="https://paperswithcode.com/search?q_meta=&q_type=&q=LCNet">PP-LCNet: A Lightweig</br>ht CPU Convolutional Neural Networ</a></td>
    ...
    <tr>
        <td>14</td>
        <td>HRNet_W18_C</td>
        <td><a href="https://paperswithcode.com/method/hrnet">Deep High-Resolution </br>Representation Learning for Visual Recognition</a></td>
    ...
    <tr>
        <td>23</td>
        <td>GoogLeNet</td>
        <td><a href="https://paperswithcode.com/model/inception-v4?variant=inception-v4-1">Inception-v4, Incepti</br>on-ResNet and the Impact of Residual Connections on Learning</a></td>
    ...
    <tr>
        <td>26</td>
        <td>ResNet18</td>
        <td><a href="https://paperswithcode.com/model/resnet">Deep Residual Learnin</br>g for Image Recognition</a></td>
    ...
    <tr>
        <td>35</td>
        <td>ResNet101</td>
        <td><a href="https://paperswithcode.com/paper/adaptively-connected-neural-networks">Adaptively Connected </br>Neural Networks</a></td>
    ...
    <tr>
        ...
        <td><a href="﻿﻿﻿https://paperswithcode.com/model/res2net">Res2Net: A New Multi-</br>scale Backbone Architecture</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/model/resnext">Aggregated Residual T</br>ransformations for Deep Neural Networks</a></td>
    ...
    <tr>
        <td>58</td>
        <td>DenseNet161</td>
        <td><a href="https://paperswithcode.com/paper/densely-connected-convolutional-networks">Densely Connected Con</br>volutional Networks</a></td>
    ...
    <tr>
        <td>67</td>
        <td>VGG11</td>
        <td><a href="https://paperswithcode.com/model/vgg">https://paperswithcod</br>e.com/method/vgg</a></td>
    ...
    <tr>
        <td>71</td>
        <td>AlexNet</td>
        <td><a href="https://paperswithcode.com/model/alexnet">ImageNet Classificati</br>on with Deep Convolutional Neural Networks</a></td>
    ...
    <tr>
        <td>72</td>
        <td>Xception41</td>
        <td><a href="https://paperswithcode.com/model/xception?variant=xception-1">Xception: Deep Learni</br>ng with Depthwise Separable Convolutions</a></td>
    ...
    <tr>
        <td>77</td>
        <td>DarkNet53</td>
        <td><a href="https://paperswithcode.com/method/darknet-53">YOLOv3: An Incrementa</br>l Improvement</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/method/efficientnet">EfficientNet: Rethink</br>ing Model Scaling for Convolutional Neural Networks</a></td>
    ...
    <tr>
        <td>86</td>
        <td>SqueezeNet1_0</td>
        <td><a href="https://paperswithcode.com/method/squeezenet">SqueezeNet: AlexNet-l</br>evel accuracy with 50x fewer parameters and <0.5MB model size</a></td>
    ...
    <tr>
        <td>88</td>
        <td>MobileNetV1</td>
        <td><a href="https://paperswithcode.com/method/mobilenetv1">MobileNets: Efficient</br> Convolutional Neural Networks for Mobile Vision Applications</a></td>
    ...
    <tr>
        <td>92</td>
        <td>MobileNetV2</td>
        <td><a href="https://paperswithcode.com/method/mobilenetv2">MobileNetV2: Inverted</br> Residuals and Linear Bottlenecks</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/method/shufflenet-v2">ShuffleNet V2: Practi</br>cal Guidelines for Efficient CNN Architecture Design</a></td>
    ...
    <tr>
        <td>118</td>
        <td>CSPDarkNet53</td>
        <td><a href="https://paperswithcode.com/model/csp-resnet?variant=cspresnet50">CSPNet: A New Backbon</br>e that can Enhance Learning Capability of CNN</a></td>
    ...
    <tr>
        <td>119</td>
        <td>GhostNet_x0_5</td>
        <td><a href="https://paperswithcode.com/method/ghostnet">GhostNet: More Featur</br>es from Cheap Operations</a></td>
    ...
    <tr>
        <td>122</td>
        <td>RegNet</td>
        <td><a href="https://paperswithcode.com/paper/regnet-self-regulated-network-for-image">RegNet: Self-Regulate</br>d Network for Image Classification</a></td>
    ...
    <tr>
        <td>133</td>
        <td>ReXNet_1_5</td>
        <td><a href="https://paperswithcode.com/paper/rexnet-diminishing-representational#code">Rethinking Channel Di</br>mensions for Efficient Model Design</a></td>
    ...
    <tr>
        <td>139</td>
        <td>MixNet_L</td>
        <td><a href="https://github.com/tensorflow/tpu/tree/master/models/official/mnasnet/mixnet">MixConv: Mixed Depthw</br>ise Convolutional Kernels</a></td>
    ...
    <tr>
        <td>142</td>
        <td>ResNeSt50</td>
        <td><a href="https://github.com/zhanghang1989/ResNeSt">ResNeSt: Split-Attent</br>ion Networks</a></td>
    ...
    <tr>
        <td>144</td>
        <td>RedNet152</td>
        <td><a href="https://paperswithcode.com/search?q_meta=&q_type=&q=RedNet">Involution: Inverting</br> the Inherence of Convolution for Visual Recognition</a></td>
    ...
    <tr>
        <td>149</td>
        <td>LeViT_128S</td>
        <td><a href="https://paperswithcode.com/method/levit">LeViT: a Vision Trans</br>former in ConvNet's Clothing for Faster Inference</a></td>
    ...
    <tr>
        <td>154</td>
        <td>alt_gvt_large</td>
        <td><a href="https://paperswithcode.com/paper/twins-revisiting-spatial-attention-design-in#code">Twins: Revisiting the</br> Design of Spatial Attention in Vision Transformers</a></td>
    ...
    <tr>
        <td>160</td>
        <td>ESNet_x0_5</td>
        <td><a href="https://paperswithcode.com/search?q_meta=&q_type=&q=PicoDet">PP-PicoDet: A Better </br>Real-Time Object Detector on Mobile Devices arXiv:2111.00902v1</a></td>
    ...
    <tr>
        <td>164</td>
        <td>HarDNet68_ds</td>
        <td><a href="https://paperswithcode.com/paper/hardnet-a-low-memory-traffic-network">HarDNet: A Low Memory</br> Traffic Network</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/an-image-is-worth-16x16-words-transformers-1">An Image is Worth 16x</br>16 Words: Transformers for Image Recognition at Scale</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/method/deit">Training data-efficie</br>nt image transformers & distillation through attention</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/swin-transformer-hierarchical-vision">Swin Transformer: Hie</br>rarchical Vision Transformer using Shifted Windows</a></td>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleDetection">PP-YOLO: An Effective</br> and Efficient Implementation of Object Detector</a></td>
    ...
    <tr>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleDetection">PP-YOLOv2: A Practica</br>l Object Detector</a></td>
    ...
    <tr>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleDetection">PP-PicoDet: A Better </br>Real-Time Object Detector on Mobile Devices</a></td>
    ...
    <tr>
        <td>13</td>
        <td>ppyoloe_crn_l_300e_co</br>co</td>
        <td><a href=""></a></td>
    ...
    <tr>
        <td>14</td>
        <td>ppyoloe_crn_m_300e_co</br>co</td>
        <td><a href=""></a></td>
        <td><details><summary>Abstract</summary><div></div></details></td>
        <td></td>
        <td><a href="">快速开始</a></td>
    ...
    <tr>
        <td>16</td>
        <td>ppyoloe_crn_x_300e_co</br>co</td>
        <td><a href=""></a></td>
        <td><details><summary>Abstract</summary><div></div></details></td>
        <td></td>
        <td><a href="">快速开始</a></td>
    ...
    <tr>
        ...
        <td><a href="https://github.com/weiliu89/caffe/tree/ssd">SSD: Single Shot Mult</br>iBox Detector</a></td>
    ...
    <tr>
        ...
        <td><a href="无">Faster R-CNN: Towards</br> Real-Time Object Detection with Region Proposal Networks</a></td>
    ...
    <tr>
        ...
        <td><a href="https://github.com/tianzhi0549/FCOS/">FCOS: Fully Convoluti</br>onal One-Stage Object Detection</a></td>
    ...
    <tr>
        ...
        <td><a href="https://pjreddie.com/darknet/yolo/">YOLOv3: An Incrementa</br>l Improvement</a></td>
        <td><details><summary>Abstract</summary><div>We present some updates to YOLO! We made a bunch of little design changes to make it better. We also trained this new network that's pretty swell. It's a little bigger than last time but more accurate. It's still fast though, don't worry. At 320x320 YOLOv3 runs in 22 ms at 28.2 mAP, as accurate as SSD but three times faster. When we look at the old .5 IOU mAP detection metric YOLOv3 is quite good. It achieves 57.9 mAP@50 in 51 ms on a Titan X, compared to 57.5 mAP@50 in 198 ms by RetinaNet, similar performance but 3.8x faster. As always, all the code is online at this https URL</div></details></td>
        <td>COCO/mAP 29.4</td>
        <td><a href="">快速开始</a></td>
        <td>支持 Paddle Inference</td>
    ...
    <tr>
        ...
        <td><a href="https://github.com/ZJULearning/ttfnet">Training-Time-Friendl</br>y Network for Real-Time Object Detection</a></td>
    ...
    <tr>
        ...
        <td><a href="https://github.com/zhaoweicai/cascade-rcnn">Cascade R-CNN: Delvin</br>g into High Quality Object Detection</a></td>
    ...
    <tr>
        ...
        <td><a href="https://github.com/zhaoweicai/Detectron-Cascade-RCNN">Cascade R-CNN: High Q</br>uality Object Detection and Instance Segmentation</a></td>
    ...
    <tr>
        ...
        <td><a href="无">BlazeFace: Sub-millis</br>econd Neural Face Detection on Mobile GPUs</a></td>
    ...
    <tr>
        ...
        <td><a href="https://github.com/csuhan/s2anet">Align Deep Features f</br>or Oriented Object Detection</a></td>
    ...
    <tr>
        ...
        <td><a href="https://git.io/AdelaiDet">SOLOv2: Dynamic, Fast</br>er and Stronger</a></td>
    ...
    <tr>
        ...
        <td><a href="https://github.com/leoxiaobin/deep-high-resolution-net.pytorch">Deep High-Resolution </br>Representation Learning for Human Pose Estimation</a></td>
    ...
    <tr>
        ...
        <td><a href="https://github.com/HRNet/HigherHRNet-Human-Pose-Estimation">HigherHRNet: Scale-Aw</br>are Representation Learning for Bottom-Up Human Pose Estimation</a></td>
    ...
    <tr>
        ...
        <td><a href="https://github.com/ifzhang/FairMOT">FairMOT: On the Fairn</br>ess of Detection and Re-Identification in Multiple Object Tracking</a></td>
    ...
    <tr>
        ...
        <td><a href="https://github.com/Zhongdao/Towards-Realtime-MOT">Towards Real-Time Mul</br>ti-Object Tracking</a></td>
    ...
    <tr>
        ...
        <td><a href="https://github.com/fundamentalvision/Deformable-DETR">Deformable DETR: Defo</br>rmable Transformers for End-to-End Object Detection</a></td>
        <td><details><summary>Abstract</summary><div>-</div></details></td>
        <td>-</td>
        <td><a href="https://github.com/PaddlePaddle/PaddleDetection/blob/develop/docs/tutorials/GETTING_STARTED_cn.md">快速开始</a></td>
        <td></td>
    ...
    <tr>
        <td>75</td>
        <td>DETR</td>
        <td><a href="https://github.com/facebookresearch/detr">DETR: End-to-End Obje</br>ct Detection with Transformers</a></td>
        <td><details><summary>Abstract</summary><div>-</div></details></td>
        <td>-</td>
        <td><a href="https://github.com/PaddlePaddle/PaddleDetection/blob/develop/docs/tutorials/GETTING_STARTED_cn.md">快速开始</a></td>
        <td></td>
    ...
    <tr>
        <td>76</td>
        <td>Sparse R-CNN</td>
        <td><a href="https://github.com/PeizeSun/SparseR-CNN">Sparse R-CNN: End-to-</br>End Object Detection with Learnable Proposals</a></td>
        <td><details><summary>Abstract</summary><div>-</div></details></td>
        <td>-</td>
        <td><a href="https://github.com/PaddlePaddle/PaddleDetection/blob/develop/docs/tutorials/GETTING_STARTED_cn.md">快速开始</a></td>
        <td></td>
    ...
    <tr>
        <td>77</td>
        <td>RetinaNet</td>
        <td><a href="https://github.com/facebookresearch/Detectron">Focal Loss for Dense </br>Object Detection</a></td>
        <td><details><summary>Abstract</summary><div>-</div></details></td>
        <td>-</td>
        <td><a href="https://github.com/PaddlePaddle/PaddleDetection/blob/develop/docs/tutorials/GETTING_STARTED_cn.md">快速开始</a></td>
        <td></td>
    ...
    <tr>
        <td>78</td>
        <td>CornerNetLite</td>
        <td><a href="无">CornerNet: Detecting </br>Objects as Paired Keypoints</a></td>
        <td><details><summary>Abstract</summary><div>-</div></details></td>
        <td>-</td>
        <td><a href="https://github.com/PaddlePaddle/PaddleDetection/blob/develop/docs/tutorials/GETTING_STARTED_cn.md">快速开始</a></td>
        <td></td>
    ...
    <tr>
        <td>79</td>
        <td>EfficientDet</td>
        <td><a href="https://github.com/google/automl/tree/master/efficientdet">EfficientDet: Scalabl</br>e and Efficient Object Detection</a></td>
        <td><details><summary>Abstract</summary><div>-</div></details></td>
        <td>-</td>
        <td><a href="https://github.com/PaddlePaddle/PaddleDetection/blob/develop/docs/tutorials/GETTING_STARTED_cn.md">快速开始</a></td>
        <td></td>
    ...
    <tr>
        <td>80</td>
        <td>Faceboxes</td>
        <td><a href="无">FaceBoxes: A CPU Real</br>-time Face Detector with High Accuracy</a></td>
        <td><details><summary>Abstract</summary><div>-</div></details></td>
        <td>-</td>
        <td><a href="https://github.com/PaddlePaddle/PaddleDetection/blob/develop/docs/tutorials/GETTING_STARTED_cn.md">快速开始</a></td>
        <td></td>
    ...
    <tr>
        <td>81</td>
        <td>Libra R-CNN</td>
        <td><a href="无">Libra R-CNN: Towards </br>Balanced Learning for Object Detection</a></td>
        <td><details><summary>Abstract</summary><div>-</div></details></td>
        <td>-</td>
        <td><a href="https://github.com/PaddlePaddle/PaddleDetection/blob/develop/docs/tutorials/GETTING_STARTED_cn.md">快速开始</a></td>
        <td></td>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/encoder-decoder-with-atrous-separable">Encoder-Decoder with </br>Atrous Separable Convolution for Semantic Image Segmentation</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/is-a-green-screen-really-necessary-for-real">Is a Green Screen Rea</br>lly Necessary for Real-Time Portrait Matting?</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/190807919">Deep High-Resolution </br>Representation Learning for Visual Recognition</a></td>
        <td><details><summary>Abstract</summary><div>High-resolution representations are essential for position-sensitive vision problems, such as human pose estimation, semantic segmentation, and object detection. Existing state-of-the-art frameworks first encode the input image as a low-resolution representation through a subnetwork that is formed by connecting high-to-low resolution convolutions \emph{in series} (e.g., ResNet, VGGNet), and then recover the high-resolution representation from the encoded low-resolution representation. Instead, our proposed network, named as High-Resolution Network (HRNet), maintains high-resolution representations through the whole process. There are two key characteristics: (i) Connect the high-to-low resolution convolution streams \emph{in parallel}; (ii) Repeatedly exchange the information across resolutions. The benefit is that the resulting representation is semantically richer and spatially more precise. We show the superiority of the proposed HRNet in a wide range of applications, including human pose estimation, semantic segmentation, and object detection, suggesting that the HRNet is a stronger backbone for computer vision problems. All the codes are available at~{\url{this https URL}}.</div></details></td>
    ...
    <tr>
        <td>6</td>
        <td>Fast-SCNN</td>
        <td><a href="https://paperswithcode.com/paper/fast-scnn-fast-semantic-segmentation-network">Fast-SCNN: Fast Seman</br>tic Segmentation Network</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/object-contextual-representations-for">Object-Contextual Rep</br>resentations for Semantic Segmentation</a></td>
    ...
    <tr>
        <td>9</td>
        <td>BiSeNetv2</td>
        <td><a href="https://paperswithcode.com/paper/bisenet-v2-bilateral-network-with-guided">BiSeNet V2: Bilateral</br> Network with Guided Aggregation for Real-time Semantic Segmentation</a></td>
    ...
    <tr>
        <td>10</td>
        <td>ENet</td>
        <td><a href="https://paperswithcode.com/paper/dual-attention-network-for-scene-segmentation">Dual Attention Networ</br>k for Scene Segmentation</a></td>
    ...
    <tr>
        <td>11</td>
        <td>SegFormer_B0</td>
        <td><a href="https://paperswithcode.com/paper/segformer-simple-and-efficient-design-for">SegFormer: Simple and</br> Efficient Design for Semantic Segmentation with Transformers</a></td>
    ...
    <tr>
        <td>12</td>
        <td>STDC_STDC1</td>
        <td><a href="https://paperswithcode.com/paper/rethinking-bisenet-for-real-time-semantic">Rethinking BiSeNet Fo</br>r Real-time Semantic Segmentation</a></td>
    ...
    <tr>
        <td>19</td>
        <td>GloRe</td>
        <td><a href="https://paperswithcode.com/paper/graph-based-global-reasoning-networks">Graph-based global re</br>asoning networks</a></td>
    ...
    <tr>
        <td>20</td>
        <td>BiSeNetV1</td>
        <td><a href="https://paperswithcode.com/paper/bisenet-bilateral-segmentation-network-for">BiSeNet: Bilateral Se</br>gmentation Network for Real-time Semantic Segmentation</a></td>
    ...
    <tr>
        <td>21</td>
        <td>FastFCN</td>
        <td><a href="https://paperswithcode.com/paper/fastfcn-rethinking-dilated-convolution-in-the">FastFCN: Rethinking D</br>ilated Convolution in the Backbone for Semantic Segmentation</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/exploring-cross-image-pixel-contrast-for">Exploring Cross-Image</br> Pixel Contrast for Semantic Segmentation</a></td>
    ...
    <tr>
        <td>23</td>
        <td>ENCNet</td>
        <td><a href="https://paperswithcode.com/paper/context-encoding-for-semantic-segmentation">ENCNet: Context Encod</br>ing for Semantic Segmentation</a></td>
    ...
    <tr>
        <td>24</td>
        <td>ESPNetV1</td>
        <td><a href="https://paperswithcode.com/paper/espnet-efficient-spatial-pyramid-of-dilated">ESPNet: Efficient Spa</br>tial Pyramid of Dilated Convolutions for Semantic Segmentation</a></td>
    ...
    <tr>
        <td>25</td>
        <td>ESPNetV2</td>
        <td><a href="https://paperswithcode.com/paper/espnetv2-a-light-weight-power-efficient-and">ESPNetv2: A Light-wei</br>ght, Power Efficient, and General Purpose Convolutional Neural Network</a></td>
    ...
    <tr>
        <td>26</td>
        <td>DMNet</td>
        <td><a href="https://paperswithcode.com/paper/dynamic-multi-scale-filters-for-semantic">Dynamic Multi-Scale F</br>ilters for Semantic Segmentation</a></td>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/pp-ocr-a-practical-ultra-lightweight-ocr">PP-OCR: A Practical U</br>ltra Lightweight OCR System</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/pp-ocrv2-bag-of-tricks-for-ultra-lightweight">PP-OCRv2: Bag of Tric</br>ks for Ultra Lightweight OCR System</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/real-time-scene-text-detection-with">Real-time Scene Text </br>Detection with Differentiable Binarization</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/east-an-efficient-and-accurate-scene-text">EAST: an efficient an</br>d accurate scene text detector</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/a-single-shot-arbitrarily-shaped-text">A Single-Shot Arbitra</br>rily-Shaped Text Detector based on Context Attended Multi-Task Learning</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/shape-robust-text-detection-with-progressive-1">Shape Robust Text Det</br>ection with Progressive Scale Expansion Network</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/what-is-wrong-with-scene-text-recognition">What Is Wrong With Sc</br>ene Text Recognition Model Comparisons? Dataset and Model Analysis</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/towards-accurate-scene-text-recognition-with">Towards Accurate Scen</br>e Text Recognition with Semantic Reasoning Networks</a></td>
    ...
    <tr>
        <td>37</td>
        <td>rec_mtb_nrtr</td>
        <td><a href="https://paperswithcode.com/paper/nrtr-a-no-recurrence-sequence-to-sequence">NRTR: A No-Recurrence</br> Sequence-to-Sequence Model For Scene Text Recognition</a></td>
    ...
    <tr>
        <td>38</td>
        <td>rec_r31_sar</td>
        <td><a href="https://paperswithcode.com/paper/show-attend-and-read-a-simple-and-strong">Show, Attend and Read</br>: A Simple and Strong Baseline for Irregular Text Recognition</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/seed-semantics-enhanced-encoder-decoder">SEED: Semantics Enhan</br>ced Encoder-Decoder Framework for Scene TextRecognition</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/pgnet-real-time-arbitrarily-shaped-text">PGNet: Real-time Arbi</br>trarily-Shaped Text Spottingwith Point Gathering Network</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/layoutparser-a-unified-toolkit-for-deep">LayoutParser: A Unifi</br>ed Toolkit for DeepLearning Based Document Image Analysis</a></td>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleOCR/blob/release/2.5/ppstructure/layout/README_ch.md">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>42</td>
        <td>PP-Structure-table</td>
        <td><a href="无">无</a></td>
        <td><details><summary>Abstract</summary><div>无</div></details></td>
        <td>PubTabNet / TEDS / 93</br>.32%</td>
        <td><a href="https://github.com/PaddlePaddle/PaddleOCR/blob/release/2.5/ppstructure/table/README_ch.md">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>43</td>
        ...
        <td><details><summary>Abstract</summary><div>无</div></details></td>
        <td>无</td>
        <td><a href="https://github.com/PaddlePaddle/PaddleOCR/blob/release/2.5/ppstructure/README_ch.md">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>44</td>
        <td>det_r50_dcn_fce_ctw_v</br>2.0</td>
        <td><a href="https://paperswithcode.com/paper/fourier-contour-embedding-for-arbitrary">Fourier Contour Embed</br>ding for Arbitrary-Shaped Text Detection</a></td>
...
<table>
    ...
    <tr>
        <td>1</td>
        <td>PP-MSVSR</td>
        <td><a href="https://paperswithcode.com/paper/pp-msvsr-multi-stage-video-super-resolution">PP-MSVSR: Multi-Stage</br> Video Super-Resolution</a></td>
    ...
    <tr>
        <td>2</td>
        <td>Pix2Pix</td>
        <td><a href="https://paperswithcode.com/paper/image-to-image-translation-with-conditional">Image-to-Image Transl</br>ation with Conditional Adversarial Networks</a></td>
    ...
    <tr>
        <td>3</td>
        <td>CycleGAN</td>
        <td><a href="https://paperswithcode.com/paper/unpaired-image-to-image-translation-using">Unpaired Image-to-Ima</br>ge Translation using Cycle-Consistent Adversarial Networkss</a></td>
    ...
    <tr>
        <td>4</td>
        <td>PSGAN</td>
        <td><a href="https://paperswithcode.com/paper/psgan-pose-robust-spatial-aware-gan-for">PSGAN: Pose and Expre</br>ssion Robust Spatial-Aware GAN for Customizable Makeup Transfer</a></td>
    ...
    <tr>
        <td>5</td>
        <td>Wav2Lip</td>
        <td><a href="https://paperswithcode.com/paper/a-lip-sync-expert-is-all-you-need-for-speech">A Lip Sync Expert Is </br>All You Need for Speech to Lip Generation In the Wild</a></td>
    ...
    <tr>
        <td>6</td>
        <td>LESRCNN</td>
        <td><a href="https://paperswithcode.com/paper/lightweight-image-super-resolution-with-2">Lightweight image sup</br>er-resolution with enhanced CNN</a></td>
    ...
    <tr>
        <td>7</td>
        <td>ESRGAN</td>
        <td><a href="https://paperswithcode.com/paper/esrgan-enhanced-super-resolution-generative">Esrgan: Enhanced supe</br>r-resolution generative adversarial networks</a></td>
    ...
    <tr>
        <td>8</td>
        <td>RealSR</td>
        <td><a href="https://paperswithcode.com/paper/real-world-super-resolution-via-kernel">Real-World Super-Reso</br>lution via Kernel Estimation and Noise Injection</a></td>
    ...
    <tr>
        <td>9</td>
        <td>StyleGAN2</td>
        <td><a href="https://paperswithcode.com/paper/analyzing-and-improving-the-image-quality-of">Analyzing and Improvi</br>ng the Image Quality of StyleGAN</a></td>
    ...
    <tr>
        <td>10</td>
        <td>U-GAT-IT</td>
        <td><a href="https://paperswithcode.com/paper/u-gat-it-unsupervised-generative-attentional">U-GAT-IT: unsupervise</br>d generative attentional networks with adaptive layer-instance normalization for image-to-image translation</a></td>
    ...
    <tr>
        <td>11</td>
        <td>AnimeGAN2</td>
        <td><a href="暂无">AnimeGAN: A Novel Lig</br>htweight GAN for Photo Animation</a></td>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleGAN/blob/develop/docs/zh_CN/tutorials/animegan.md">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>12</td>
    ...
    <tr>
        <td>13</td>
        <td>DRN</td>
        <td><a href="https://paperswithcode.com/paper/closed-loop-matters-dual-regression-networks">Closed-loop Matters: </br>Dual Regression Networks for Single Image Super-Resolution</a></td>
    ...
    <tr>
        <td>14</td>
        <td>starGAN2</td>
        <td><a href="https://paperswithcode.com/paper/stargan-v2-diverse-image-synthesis-for">StarGAN v2: Diverse I</br>mage Synthesis for Multiple Domains</a></td>
    ...
    <tr>
        <td>15</td>
        <td>FOM</td>
        <td><a href="https://paperswithcode.com/paper/first-order-motion-model-for-image-animation-1">First Order Motion Mo</br>del for Image Animation</a></td>
    ...
    <tr>
        <td>16</td>
        <td>EDVR</td>
        <td><a href="https://paperswithcode.com/paper/edvr-video-restoration-with-enhanced">EDVR: Video Restorati</br>on with Enhanced Deformable Convolutional Networks</a></td>
    ...
    <tr>
        <td>17</td>
        <td>BasicVSR++</td>
        <td><a href="https://paperswithcode.com/paper/basicvsr-the-search-for-essential-components">BasicVSR++: Improving</br> Video Super-Resolution with Enhanced Propagation and Alignment</a></td>
    ...
    <tr>
        <td>18</td>
        <td>BasicVSR</td>
        <td><a href="https://paperswithcode.com/paper/basicvsr-the-search-for-essential-components">BasicVSR: The Search </br>for Essential Components in Video Super-Resolution and Beyond</a></td>
        <td><details><summary>Abstract</summary><div>Video super-resolution (VSR) approaches tend to have more components than the image counterparts as they need to exploit the additional temporal dimension. Complex designs are not uncommon. In this study, we wish to untangle the knots and reconsider some most essential components for VSR guided by four basic functionalities, i.e., Propagation, Alignment, Aggregation, and Upsampling. By reusing some existing components added with minimal redesigns, we show a succinct pipeline, BasicVSR, that achieves appealing improvements in terms of speed and restoration quality in comparison to many state-of-the-art algorithms. We conduct systematic analysis to explain how such gain can be obtained and discuss the pitfalls. We further show the extensibility of BasicVSR by presenting an information-refill mechanism and a coupled propagation scheme to facilitate information aggregation. The BasicVSR and its extension, IconVSR, can serve as strong baselines for future VSR approaches.</div></details></td>
        <td>REDS/pnsr:30.4429 ssi</br>m:0.8684</td>
        <td><a href="https://github.com/PaddlePaddle/PaddleGAN/blob/develop/docs/zh_CN/tutorials/video_super_resolution.md">快速开始</a></td>
        <td>支持 Paddle Inference</td>
    ...
    <tr>
        <td>19</td>
        <td>LapStyle</td>
        <td><a href="https://paperswithcode.com/paper/drafting-and-revision-laplacian-pyramid">Drafting and Revision</br>: Laplacian Pyramid Network for Fast High-Quality Artistic Style Transfer</a></td>
    ...
    <tr>
        <td>20</td>
        <td>DCGAN</td>
        <td><a href="https://paperswithcode.com/method/dcgan">Unsupervised Represen</br>tation Learning with Deep Convolutional Generative Adversarial Networks</a></td>
    ...
    <tr>
        <td>21</td>
        <td>CGAN</td>
        <td><a href="https://paperswithcode.com/paper/conditional-generative-adversarial-nets">Conditional Generativ</br>e Adversarial Nets</a></td>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/beyond-short-snippets-deep-networks-for-video">Beyond Short Snippets</br>: Deep Networks for Video Classification</a></td>
    ...
    <tr>
        <td>2</td>
        <td>TSM</td>
        <td><a href="https://paperswithcode.com/paper/temporal-shift-module-for-efficient-video">TSM: Temporal Shift M</br>odule for Efficient Video Understanding</a></td>
    ...
    <tr>
        <td>4</td>
        <td>TSN</td>
        <td><a href="https://paperswithcode.com/paper/temporal-segment-networks-for-action">Temporal Segment Netw</br>orks for Action Recognition in Video</a></td>
    ...
    <tr>
        <td>6</td>
        <td>SlowFast</td>
        <td><a href="https://paperswithcode.com/paper/slowfast-networks-for-video-recognition">SlowFast Networks for</br> Video Recognition</a></td>
    ...
    <tr>
        <td>7</td>
        <td>TimeSformer</td>
        <td><a href="https://paperswithcode.com/paper/is-space-time-attention-all-you-need-for">Is Space-Time Attenti</br>on All You Need for Video Understanding?</a></td>
    ...
    <tr>
        <td>8</td>
        <td>ST-GCN</td>
        <td><a href="https://paperswithcode.com/paper/spatial-temporal-graph-convolutional-networks-1">Spatial Temporal Grap</br>h Convolutional Networks for Skeleton-Based Action Recognition</a></td>
    ...
    <tr>
        <td>9</td>
        <td>AGCN</td>
        <td><a href="https://paperswithcode.com/paper/skeleton-based-action-recognition-with-multi">Skeleton-Based Action</br> Recognition with Multi-Stream Adaptive Graph Convolutional Networks</a></td>
    ...
    <tr>
        <td>10</td>
        <td>BMN</td>
        <td><a href="https://paperswithcode.com/paper/bmn-boundary-matching-network-for-temporal">BMN: Boundary-Matchin</br>g Network for Temporal Action Proposal Generation</a></td>
...
<table>
    ...
    <tr>
        <td>1</td>
        <td>IGSQL</td>
        <td><a href="https://paperswithcode.com/paper/igsql-database-schema-interaction-graph-based"> IGSQL: Database Sche</br>ma Interaction Graph Based Neural Model for Context-Dependent Text-to-SQL Generation</a></td>
    ...
    <tr>
        <td>2</td>
        <td>RAT-SQL</td>
        <td><a href="https://paperswithcode.com/paper/rat-sql-relation-aware-schema-encoding-and-1">RAT-SQL: Relation-Awa</br>re Schema Encoding and Linking for Text-to-SQL Parsers</a></td>
        ...
        <td>DuSQL: 64.3</td>
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/text_to_sql/RAT-SQL">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>3</td>
        <td>BiGRU-CRF</td>
        <td><a href="https://paperswithcode.com/paper/chinese-lexical-analysis-with-deep-bi-gru-crf#code">Chinese Lexical Analy</br>sis with Deep Bi-GRU-CRF Network</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/deep-biaffine-attention-for-neural-dependency">Deep Biaffine Attenti</br>on for Neural Dependency Parsing</a></td>
    ...
    <tr>
        <td>5</td>
        <td>ERNIE-CSC</td>
        <td><a href="https://paperswithcode.com/paper/correcting-chinese-spelling-errors-with">Correcting Chinese Sp</br>elling Errors with Phonetic Pre-training</a></td>
    ...
    <tr>
        <td>6</td>
        <td>PLATO-2</td>
        <td><a href="https://paperswithcode.com/paper/plato-2-towards-building-an-open-domain">PLATO-2: Towards Buil</br>ding an Open-Domain Chatbot via Curriculum Learning</a></td>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/dialogue/plato-2">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>7</td>
        <td>Seq2Seq</td>
        <td><a href="Neural Machine Translation By Jointly Learning To Align And Translate">Neural Machine Transl</br>ation By Jointly Learning To Align And Translate</a></td>
    ...
    <tr>
        <td>9</td>
        <td>STACL</td>
        <td><a href="https://paperswithcode.com/paper/stacl-simultaneous-translation-with">STACL: Simultaneous T</br>ranslation with Implicit Anticipation and Controllable Latency using Prefix-to-Prefix Framework</a></td>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/simultaneous_translation/stacl">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>10</td>
        <td>SKEP</td>
        <td><a href="https://paperswithcode.com/paper/skep-sentiment-knowledge-enhanced-pre">SKEP: Sentiment Knowl</br>edge Enhanced Pre-training for Sentiment Analysis</a></td>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/sentiment_analysis/skep">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>11</td>
        ...
        <td><details><summary>Abstract</summary><div>-</div></details></td>
        <td></td>
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/text_matching/simnet">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>12</td>
        <td>Sentence-Transformer</td>
        <td><a href="https://paperswithcode.com/paper/sentence-bert-sentence-embeddings-using">Sentence-BERT: Senten</br>ce Embeddings using Siamese BERT-Networks</a></td>
    ...
    <tr>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/few_shot/efl">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>14</td>
        <td>PET</td>
        <td><a href="https://paperswithcode.com/paper/exploiting-cloze-questions-for-few-shot-text-1">Exploiting Cloze Ques</br>tions for Few Shot Text Classification and Natural Language Inference</a></td>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/few_shot/pet">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>15</td>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/few_shot/p-tuning">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>16</td>
        <td>Pointer Generator Net</br>work</td>
        <td><a href="https://paperswithcode.com/paper/get-to-the-point-summarization-with-pointer">Get To The Point: Sum</br>marization with Pointer-Generator Networks</a></td>
    ...
    <tr>
        <td>17</td>
        <td>ERNIE</td>
        <td><a href="https://paperswithcode.com/paper/ernie-enhanced-representation-through">ERNIE: Enhanced Repre</br>sentation through Knowledge Integration</a></td>
        ...
        <td>XNLI / dev: 79.9</td>
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/blob/develop/docs/model_zoo/transformers.rst">快速开始</a></td>
        <td>支持 Paddle Inference</td>
    </tr>
    <tr>
        <td>18</td>
        <td>ERNIE-DOC</td>
        <td><a href="https://paperswithcode.com/paper/ernie-doc-the-retrospective-long-document">ERNIE-Doc: A Retrospe</br>ctive Long-Document Modeling Transformer</a></td>
    ...
    <tr>
        <td>19</td>
        <td>ERNIE-GEN</td>
        <td><a href="https://paperswithcode.com/paper/ernie-gen-an-enhanced-multi-flow-pre-training">ERNIE-GEN: An Enhance</br>d Multi-Flow Pre-training and Fine-tuning Framework for Natural Language Generation</a></td>
    ...
    <tr>
        <td>20</td>
        <td>ERNIE-GRAM</td>
        <td><a href="https://paperswithcode.com/paper/ernie-gram-pre-training-with-explicitly-n">ERNIE-Gram: Pre-Train</br>ing with Explicitly N-Gram Masked Language Modeling for Natural Language Understanding</a></td>
    ...
    <tr>
        <td>21</td>
        <td>RoFormer</td>
        <td><a href="https://paperswithcode.com/paper/roformer-enhanced-transformer-with-rotary">RoFormer: Enhanced Tr</br>ansformer with Rotary Position Embedding</a></td>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/language_model/roformer">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>22</td>
        <td>BART</td>
        <td><a href="https://paperswithcode.com/paper/bart-denoising-sequence-to-sequence-pre">BART: Denoising Seque</br>nce-to-Sequence Pre-training for Natural Language Generation, Translation, and Comprehension</a></td>
    ...
    <tr>
        <td>23</td>
        <td>ALBERT</td>
        <td><a href="https://paperswithcode.com/paper/albert-a-lite-bert-for-self-supervised">ALBERT: A Lite BERT f</br>or Self-supervised Learning of Language Representations</a></td>
    ...
    <tr>
        <td>24</td>
        <td>BERT</td>
        <td><a href="https://paperswithcode.com/paper/bert-pre-training-of-deep-bidirectional">BERT: Pre-training of</br> Deep Bidirectional Transformers for Language Understanding</a></td>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/language_model/bert">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>25</td>
        <td>BigBird</td>
        <td><a href="https://paperswithcode.com/paper/big-bird-transformers-for-longer-sequences">Big Bird: Transformer</br>s for Longer Sequences</a></td>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/language_model/bigbird">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>26</td>
        <td>DistilBert</td>
        <td><a href="https://paperswithcode.com/method/distillbert">DistilBERT, a distill</br>ed version of BERT: smaller, faster, cheaper and lighter</a></td>
    ...
    <tr>
        <td>27</td>
        <td>ELECTRA</td>
        <td><a href="https://paperswithcode.com/paper/electra-pre-training-text-encoders-as-1">ELECTRA: Pre-training</br> Text Encoders as Discriminators Rather Than Generators</a></td>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/language_model/electra">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>28</td>
        <td>GPT</td>
        <td><a href="https://paperswithcode.com/method/gpt-2">Language Models are U</br>nsupervised Multitask Learners</a></td>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/language_model/gpt">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>29</td>
        <td>NeZha</td>
        <td><a href="https://paperswithcode.com/paper/nezha-neural-contextualized-representation">NEZHA: Neural Context</br>ualized Representation for Chinese Language Understanding</a></td>
    ...
    <tr>
        <td>30</td>
        <td>RoBERTa</td>
        <td><a href="https://paperswithcode.com/method/roberta">RoBERTa: A Robustly O</br>ptimized BERT Pretraining Approach</a></td>
    ...
    <tr>
        <td>31</td>
        <td>MiniLMv2</td>
        <td><a href="https://paperswithcode.com/search?q_meta=&q_type=&q=MiniLMv2">MINILMv2: Multi-Head </br>Self-Attention Relation Distillation for Compressing Pretrained Transformers</a></td>
        ...
        <td><a href="https://github.com/PaddlePaddle/PaddleNLP/tree/develop/examples/model_compression/minilmv2">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>32</td>
        <td>TinyBert</td>
        <td><a href="https://paperswithcode.com/paper/190910351">TinyBERT: Distilling </br>BERT for Natural Language Understanding</a></td>
    ...
    <tr>
        <td>33</td>
        <td>XLNet</td>
        <td><a href="https://paperswithcode.com/paper/xlnet-generalized-autoregressive-pretraining">XLNet: Generalized Au</br>toregressive Pretraining for Language Understanding</a></td>
...
<table>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/unified-streaming-and-non-streaming-two-pass">Unified Streaming and</br> Non-streaming Two-pass End-to-end Model for Speech Recognition</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/deep-speech-2-end-to-end-speech-recognition">Deep Speech 2: End-to</br>-End Speech Recognition in English and Mandarin</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/fastspeech-2-fast-and-high-quality-end-to-end">FastSpeech 2: Fast an</br>d High-Quality End-to-End Text to Speech</a></td>
    ...
    <tr>
        <td>5</td>
        <td>speedyspeech</td>
        <td><a href="https://paperswithcode.com/paper/speedyspeech-efficient-neural-speech">SpeedySpeech: Efficie</br>nt Neural Speech Synthesis</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/neural-speech-synthesis-with-transformer">Neural Speech Synthes</br>is with Transformer Network</a></td>
    ...
    <tr>
        <td>7</td>
        <td>PP-Waveflow</td>
        <td><a href="https://paperswithcode.com/paper/waveflow-a-compact-flow-based-model-for-raw-1">WaveFlow: A Compact F</br>low-based Model for Raw Audio</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/parallel-wavegan-a-fast-waveform-generation">PARALLEL WAVEGAN: A F</br>AST WAVEFORM GENERATION MODEL BASED ON GENERATIVE ADVERSARIAL NETWORKS WITH MULTI-RESOLUTION SPECTROGRAM</a></td>
    ...
    <tr>
        <td>9</td>
        <td>MelGAN</td>
        <td><a href="https://paperswithcode.com/method/melgan">MelGAN: Generative Ad</br>versarial Networks for Conditional Waveform Synthesis</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/method/multi-band-melgan">Multi-band MelGAN: Fa</br>ster Waveform Generation for High-Quality Text-to-Speech</a></td>
    ...
    <tr>
        <td>11</td>
        <td>WaveRNN</td>
        <td><a href="https://paperswithcode.com/method/wavernn">Efficient Neural Audi</br>o Synthesis</a></td>
    ...
    <tr>
        <td>12</td>
        <td>Style MelGAN</td>
        <td><a href="https://paperswithcode.com/paper/stylemelgan-an-efficient-high-fidelity">StyleMelGAN: An Effic</br>ient High-Fidelity Adversarial Vocoder with Temporal Adaptive Normalization</a></td>
    ...
    <tr>
        <td>13</td>
        <td>hifigan</td>
        <td><a href="https://paperswithcode.com/paper/hifi-gan-generative-adversarial-networks-for">HiFi-GAN: Generative </br>Adversarial Networks for Efficient and High Fidelity Speech Synthesis</a></td>
    ...
    <tr>
        <td>14</td>
        <td>ecapa-tdnn</td>
        <td><a href="https://paperswithcode.com/paper/ecapa-tdnn-emphasized-channel-attention">ECAPA-TDNN: Emphasize</br>d Channel Attention, Propagation and Aggregation in TDNN Based Speaker Verification</a></td>
    ...
    <tr>
        <td>15</td>
        <td>MDTC</td>
        <td><a href="https://paperswithcode.com/paper/the-npu-system-for-the-2020-personalized">The NPU System for th</br>e 2020 Personalized Voice Trigger Challenge</a></td>
    ...
    <tr>
        <td>16</td>
        <td>GE2E</td>
        <td><a href="https://paperswithcode.com/paper/generalized-end-to-end-loss-for-speaker">Generalized End-to-En</br>d Loss for Speaker Verification</a></td>
    ...
    <tr>
        <td>17</td>
        <td>VoiceCloning</td>
        <td><a href="https://paperswithcode.com/paper/transfer-learning-from-speaker-verification">Transfer Learning fro</br>m Speaker Verification toMultispeaker Text-To-Speech Synthesis</a></td>
    ...
    <tr>
        <td>18</td>
        <td>tacotron2</td>
        <td><a href="https://paperswithcode.com/paper/neural-speech-synthesis-with-transformer">Natural TTS Synthesis</br> by Conditioning WaveNet on Mel Spectrogram Predictions</a></td>
...
<table>
    ...
    <tr>
        <td>1</td>
        <td>DSSM</td>
        <td><a href="https://paperswithcode.com/paper/learning-deep-structured-semantic-models-for">Learning Deep Structu</br>red Semantic Models for Web Search using Clickthrough Data</a></td>
    ...
    <tr>
        <td>2</td>
        <td>Match-Pyramid</td>
        <td><a href="https://paperswithcode.com/paper/text-matching-as-image-recognition">Text Matching as Imag</br>e Recognition</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/a-multi-view-deep-learning-approach-for-cross">A Multi-View Deep Lea</br>rning Approach for Cross Domain User Modeling in Recommendation Systems</a></td>
    ...
    <tr>
        <td>4</td>
        <td>DeepWalk</td>
        <td><a href="https://paperswithcode.com/paper/deepwalk-online-learning-of-social">DeepWalk: Online Lear</br>ning of Social Representations</a></td>
    ...
    <tr>
        <td>5</td>
        <td>Mind</td>
        <td><a href="https://paperswithcode.com/paper/multi-interest-network-with-dynamic-routing">Multi-Interest Networ</br>k with Dynamic Routing for Recommendation at Tmall</a></td>
    ...
    <tr>
        <td>7</td>
        <td>Word2vec</td>
        <td><a href="https://paperswithcode.com/paper/distributed-representations-of-words-and-1">Distributed Represent</br>ations of Words and Phrases and their Compositionality</a></td>
    ...
    <tr>
        <td>8</td>
        <td>Fasttext</td>
        <td><a href="https://paperswithcode.com/paper/bag-of-tricks-for-efficient-text">Bag of Tricks for Eff</br>icient Text Classification</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/session-based-recommendation-with-graph">Session-based Recomme</br>ndation with Graph Neural Networks</a></td>
    ...
    <tr>
        <td>10</td>
        <td>GRU4Rec</td>
        <td><a href="https://paperswithcode.com/paper/session-based-recommendations-with-recurrent">Session-based Recomme</br>ndations with Recurrent Neural Networks</a></td>
    ...
    <tr>
        <td>11</td>
        <td>RALM</td>
        <td><a href="https://paperswithcode.com/paper/real-time-attention-based-look-alike-model">Real-time Attention B</br>ased Look-alike Model for Recommender System</a></td>
    ...
    <tr>
        <td>12</td>
        <td>SSR</td>
        <td><a href="https://dl.acm.org/doi/10.1145/2911451.2914726">Multtti-Rate Deep Lea</br>rning for Temporal Recommendation</a></td>
    ...
    <tr>
        <td>13</td>
        <td>Youtube_dnn</td>
        <td><a href="https://paperswithcode.com/paper/deep-neural-networks-for-youtube">Deep Neural Networks </br>for YouTube Recommendations</a></td>
    ...
    <tr>
        <td>14</td>
        <td>BST</td>
        <td><a href="https://paperswithcode.com/paper/behavior-sequence-transformer-for-e-commerce">Behavior Sequence Tra</br>nsformer for E-commerce Recommendation in Alibaba</a></td>
    ...
    <tr>
        <td>15</td>
        <td>DCN</td>
        <td><a href="https://paperswithcode.com/paper/deep-cross-network-for-ad-click-predictions">Deep & Cross Network </br>for Ad Click Predictions</a></td>
    ...
    <tr>
        <td>16</td>
        <td>DeepFM</td>
        <td><a href="https://paperswithcode.com/paper/deepfm-a-factorization-machine-based-neural">DeepFM: A Factorizati</br>on-Machine based Neural Network for CTR Prediction</a></td>
    ...
    <tr>
        <td>17</td>
        <td>DMR</td>
        <td><a href="https://paperswithcode.com/paper/deep-match-to-rank-model-for-personalized">Deep Match to Rank Mo</br>del for Personalized Click-Through Rate Prediction</a></td>
    ...
    <tr>
        <td>19</td>
        <td>FFM</td>
        <td><a href="https://paperswithcode.com/paper/field-aware-factorization-machines-for-ctr">Field-aware Factoriza</br>tion Machines for CTR Prediction</a></td>
    ...
    <tr>
        <td>21</td>
        <td>GateNet</td>
        <td><a href="https://paperswithcode.com/paper/gatenet-gating-enhanced-deep-network-for">GateNet: Gating-Enhan</br>ced Deep Network for Click-Through Rate Prediction</a></td>
    ...
    <tr>
        <td>23</td>
        <td>Naml</td>
        <td><a href="https://paperswithcode.com/paper/neural-news-recommendation-with-attentive">Neural News Recommend</br>ation with Attentive Multi-View Learning</a></td>
    ...
    <tr>
        <td>24</td>
        <td>Wide&Deep</td>
        <td><a href="https://paperswithcode.com/paper/wide-deep-learning-for-recommender-systems">Wide & Deep Learning </br>for Recommender Systems</a></td>
    ...
    <tr>
        <td>25</td>
        <td>XDeepFM</td>
        <td><a href="https://paperswithcode.com/paper/xdeepfm-combining-explicit-and-implicit">xDeepFM: Combining Ex</br>plicit and Implicit Feature Interactions for Recommender Systems</a></td>
    ...
    <tr>
        <td>26</td>
        <td>AutoInt</td>
        <td><a href="https://paperswithcode.com/paper/autoint-automatic-feature-interaction">AutoInt: Automatic Fe</br>ature Interaction Learning via Self-Attentive Neural Networks</a></td>
    ...
    <tr>
        <td>27</td>
        <td>AFM</td>
        <td><a href="https://paperswithcode.com/paper/attentional-factorization-machines-learning">Attentional Factoriza</br>tion Machines: Learning the Weight of Feature Interactions via Attention Networks</a></td>
    ...
    <tr>
        <td>28</td>
        <td>DeepCross</td>
        <td><a href="https://paperswithcode.com/paper/deep-crossing-web-scale-modeling-without">Deep Crossing: Web-Sc</br>ale Modeling without Manually Crafted Combinatorial Features</a></td>
    ...
    <tr>
        <td>29</td>
        <td>DIEN</td>
        <td><a href="https://paperswithcode.com/paper/deep-interest-evolution-network-for-click">Deep Interest Evoluti</br>on Network for Click-Through Rate Prediction</a></td>
    ...
    <tr>
        <td>30</td>
        <td>DIN</td>
        <td><a href="https://paperswithcode.com/paper/deep-interest-network-for-click-through-rate">Deep Interest Network</br> for Click-Through Rate Prediction</a></td>
    ...
    <tr>
        <td>31</td>
        <td>FGCNN</td>
        <td><a href="https://paperswithcode.com/paper/feature-generation-by-convolutional-neural">Feature Generation by</br> Convolutional Neural Network for Click-Through Rate Prediction</a></td>
    ...
    <tr>
        <td>32</td>
        <td>Fibinet</td>
        <td><a href="https://paperswithcode.com/paper/fibinet-combining-feature-importance-and">FiBiNET: Combining Fe</br>ature Importance and Bilinear feature Interaction for Click-Through Rate Prediction</a></td>
    ...
    <tr>
        <td>33</td>
        <td>FLEN</td>
        <td><a href="https://paperswithcode.com/paper/flen-leveraging-field-for-scalable-ctr">FLEN: Leveraging Fiel</br>d for Scalable CTR Prediction</a></td>
    ...
    <tr>
        <td>34</td>
        <td>FNN</td>
        <td><a href="https://paperswithcode.com/paper/deep-learning-over-multi-field-categorical">Deep Learning over Mu</br>lti-field Categorical Data</a></td>
    ...
    <tr>
        <td>35</td>
        <td>NFM</td>
        <td><a href="https://paperswithcode.com/paper/neural-factorization-machines-for-sparse">Neural Factorization </br>Machines for Sparse Predictive Analytics</a></td>
    ...
    <tr>
        <td>36</td>
        <td>PNN</td>
        <td><a href="https://paperswithcode.com/paper/product-based-neural-networks-for-user">Product-based Neural </br>Networks for User Response Prediction</a></td>
    ...
    <tr>
        <td>37</td>
        <td>ESMM</td>
        <td><a href="https://paperswithcode.com/paper/entire-space-multi-task-model-an-effective">Entire Space Multi-Ta</br>sk Model: An Effective Approach for Estimating Post-Click Conversion Rate</a></td>
    ...
    <tr>
        <td>38</td>
        <td>MMOE</td>
        <td><a href="https://paperswithcode.com/paper/modeling-task-relationships-in-multi-task">Modeling Task Relatio</br>nships in Multi-task Learning with Multi-gate Mixture-of-Experts</a></td>
    ...
    <tr>
        <td>39</td>
        <td>PLE</td>
        <td><a href="https://paperswithcode.com/paper/progressive-layered-extraction-ple-a-novel">Progressive Layered E</br>xtraction (PLE): A Novel Multi-Task Learning (MTL) Model for Personalized Recommendations</a></td>
    ...
    <tr>
        <td>41</td>
        <td>Maml</td>
        <td><a href="https://paperswithcode.com/paper/model-agnostic-meta-learning-for-fast">Model-agnostic meta-l</br>earning for fast adaptation of deep networks</a></td>
    ...
    <tr>
        <td>42</td>
        <td>Listwise</td>
        <td><a href="https://paperswithcode.com/paper/sequential-evaluation-and-generation">Sequential Evaluation</br> and Generation Framework for Combinatorial Recommender System</a></td>
    ...
    <tr>
        <td>43</td>
        <td>TDM</td>
        <td><a href="https://arxiv.org/pdf/1801.02294.pdf">Learning Tree-based D</br>eep Model for Recommender Systems</a></td>
    ...
    <tr>
        <td>44</td>
        <td>Tagspace</td>
        <td><a href="https://paperswithcode.com/paper/tagspace-semantic-embeddings-from-hashtags">TagSpace: Semantic Em</br>beddings from Hashtags</a></td>
    ...
    <tr>
        <td>45</td>
        <td>Textcnn</td>
        <td><a href="https://aclanthology.org/D14-1181.pdf">Convolutional neural </br>networks for sentence classication</a></td>
    ...
    <tr>
        <td>46</td>
        <td> DIFM</td>
        <td><a href="https://paperswithcode.com/paper/a-dual-input-aware-factorization-machine-for">A Dual Input-aware Fa</br>ctorization Machine for CTR Prediction</a></td>
        ...
        <td>criteo</td>
        <td><a href="https://github.com/PaddlePaddle/PASSL/tree/main/configs/cait">快速开始</a></td>
        <td></td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>3</td>
        <td>XCiT</td>
        <td><a href="https://paperswithcode.com/paper/xcit-cross-covariance-image-transformers#code">XCiT: Cross-Covarianc</br>e Image Transformers</a></td>
        ...
        <td>Acc</td>
        <td><a href="https://github.com/PaddlePaddle/PASSL/tree/main/configs/xcit">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>4</td>
        <td>ViT</td>
        <td><a href="https://paperswithcode.com/paper/an-image-is-worth-16x16-words-transformers-1#code">An Image is Worth 16x</br>16 Words: Transformers for Image Recognition at Scale</a></td>
        <td><details><summary>Abstract</summary><div>While the Transformer architecture has become the de-facto standard for naturallanguage processing tasks, its applications to computer vision remain limited. Invision, attention is either applied in conjunction with convolutional networks, orused to replace certain components of convolutional networks while keeping theiroverall structure in place. We show that this reliance on CNNs is not necessaryand a pure transformer applied directly to sequences of image patches can performvery well on image classification tasks. When pre-trained on large amounts ofdata and transferred to multiple mid-sized or small image recognition benchmarks(ImageNet, CIFAR-100, VTAB, etc.), Vision Transformer (ViT) attains excellentresults compared to state-of-the-art convolutional networks while requiring substantially fewer computational resources to train.1</div></details></td>
        <td>Acc</td>
        <td><a href="">快速开始</a></td>
        <td></td>
    </tr>
    ...
    <tr>
        <td>13</td>
        <td>BYOL</td>
        <td><a href="https://paperswithcode.com/method/byol">Bootstrap Your Own La</br>tent - A New Approach to Self-Supervised Learning</a></td>
        <td><details><summary>Abstract</summary><div>We introduce Bootstrap Your Own Latent (BYOL), a new approach to selfsupervised image representation learning. BYOL relies on two neural networks,referred to as online and target networks, that interact and learn from each other.From an augmented view of an image, we train the online network to predict thetarget network representation of the same image under a different augmented view.At the same time, we update the target network with a slow-moving average ofthe online network. While state-of-the art methods rely on negative pairs, BYOLachieves a new state of the art without them. BYOL reaches 74.3% top-1 classification accuracy on ImageNet using a linear evaluation with a ResNet-50 architectureand 79.6% with a larger ResNet. We show that BYOL performs on par or better thanthe current state of the art on both transfer and semi-supervised benchmarks. Ourimplementation and pretrained models are given on GitHub.3</div></details></td>
        <td>Acc</td>
        <td><a href="https://github.com/PaddlePaddle/PASSL/blob/main/docs/Train_BYOL_model.md">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>14</td>
        <td>PixPro</td>
        <td><a href="https://paperswithcode.com/paper/propagate-yourself-exploring-pixel-level">Propagate Yourself: E</br>xploring Pixel-Level Consistency for Unsupervised Visual Representation Learning</a></td>
        <td><details><summary>Abstract</summary><div>Contrastive learning methods for unsupervised visualrepresentation learning have reached remarkable levels oftransfer performance. We argue that the power of contrastive learning has yet to be fully unleashed, as currentmethods are trained only on instance-level pretext tasks,leading to representations that may be sub-optimal fordownstream tasks requiring dense pixel predictions. In thispaper, we introduce pixel-level pretext tasks for learningdense feature representations. The first task directly applies contrastive learning at the pixel level. We additionally propose a pixel-to-propagation consistency task thatproduces better results, even surpassing the state-of-the-artapproaches by a large margin. Specifically, it achieves 60.2AP, 41.4 / 40.5 mAP and 77.2 mIoU when transferred toPascal VOC object detection (C4), COCO object detection(FPN / C4) and Cityscapes semantic segmentation using aResNet-50 backbone network, which are 2.6 AP, 0.8 / 1.0mAP and 1.0 mIoU better than the previous best methodsbuilt on instance-level contrastive learning. Moreover, thepixel-level pretext tasks are found to be effective for pretraining not only regular backbone networks but also headnetworks used for dense downstream tasks, and are complementary to instance-level contrastive methods. Theseresults demonstrate the strong potential of defining pretexttasks at the pixel level, and suggest a new path forward inunsupervised visual representation learning. Code is available at https://github.com/zdaxie/PixPro.</div></details></td>
        <td>Acc</td>
        <td><a href="https://github.com/PaddlePaddle/PASSL/blob/main/docs/Train_PixPro_model.md">快速开始</a></td>
        <td></td>
    </tr>
    <tr>
        <td>15</td>
        <td>CaiT</td>
        <td><a href="https://paperswithcode.com/method/cait">Going deeper with Ima</br>ge Transformers</a></td>
        <td><details><summary>Abstract</summary><div>Transformers have been recently adapted for large scale image classification, achieving high scores shaking up the long supremacy of convolutional neural networks. However the optimization of image transformershas been little studied so far. In this work, we build and optimize deepertransformer networks for image classification. In particular, we investigatethe interplay of architecture and optimization of such dedicated transformers. We make two transformers architecture changes that significantly improve the accuracy of deep transformers. This leads us to produce modelswhose performance does not saturate early with more depth, for instancewe obtain 86.5% top-1 accuracy on Imagenet when training with no external data, we thus attain the current SOTA with less FLOPs and parameters.Moreover, our best model establishes the new state of the art on Imagenetwith Reassessed labels and Imagenet-V2 / match frequency, in the settingwith no additional training data. We share our code and models1.</div></details></td>
        <td>Acc</td>
        <td><a href="https://github.com/PaddlePaddle/PASSL/tree/main/configs/cait">快速开始</a></td>
        <td></td>
    </tr>
...
<table>
    ...
    <tr>
        <td>2</td>
        <td>PPO</td>
        <td><a href="https://paperswithcode.com/paper/proximal-policy-optimization-algorithms">Proximal Policy Optim</br>ization Algorithms</a></td>
    ...
    <tr>
        <td>3</td>
        <td>GA3C</td>
        <td><a href="无">GA3C: GPU-based A3C f</br>or Deep Reinforcement Learning</a></td>
        <td><details><summary>Abstract</summary><div>无</div></details></td>
        <td>reward</td>
    ...
    <tr>
        <td>4</td>
        <td>SAC</td>
        <td><a href="https://paperswithcode.com/paper/soft-actor-critic-off-policy-maximum-entropy">Soft Actor-Critic: Of</br>f-Policy Maximum Entropy Deep Reinforcement Learning with a Stochastic Actor</a></td>
    ...
    <tr>
        <td>5</td>
        <td>IMPALA</td>
        <td><a href="https://paperswithcode.com/paper/impala-scalable-distributed-deep-rl-with">Impala: Scalable dist</br>ributed deep-rl with importance weighted actor-learner architectures</a></td>
    ...
    <tr>
        <td>6</td>
        <td>DDPG</td>
        <td><a href="https://paperswithcode.com/paper/continuous-control-with-deep-reinforcement">Continuous control wi</br>th deep reinforcement learning</a></td>
    ...
    <tr>
        ...
        <td><a href="无">同 NeurIPS2018-AI-for-</br>Prosthetics-Challenge</a></td>
        <td><details><summary>Abstract</summary><div>无</div></details></td>
        <td>reward</td>
    ...
    <tr>
        <td>9</td>
        <td>TD3</td>
        <td><a href="https://paperswithcode.com/paper/addressing-function-approximation-error-in">Addressing Function A</br>pproximation Error in Actor-Critic Methods</a></td>
    ...
    <tr>
        <td>10</td>
        <td>DQN</td>
        <td><a href="https://paperswithcode.com/paper/human-level-control-through-deep">Human-level Control T</br>hrough Deep Reinforcement Learning</a></td>
    ...
    <tr>
        <td>11</td>
        <td>ES</td>
        <td><a href="https://paperswithcode.com/paper/evolution-strategies-as-a-scalable">Evolution Strategies </br>as a Scalable Alternative to Reinforcement Learning</a></td>
    ...
    <tr>
        <td>12</td>
        <td>DQN_variant</td>
        <td><a href="https://paperswithcode.com/paper/deep-reinforcement-learning-with-double-q">Deep Reinforcement Le</br>arning with Double Q-learning</a></td>
    ...
    <tr>
        <td>13</td>
        <td>A2C</td>
        <td><a href="https://paperswithcode.com/paper/asynchronous-methods-for-deep-reinforcement">A2C is a synchronous,</br> deterministic variant of Asynchronous Advantage Actor Critic (A3C) </a></td>
    ...
    <tr>
        ...
        <td><a href="无">Efficient and Robust </br>Learning on Elaborated Gaits with Curriculum Learning</a></td>
        <td><details><summary>Abstract</summary><div>无</div></details></td>
        <td>reward</td>
    ...
    <tr>
        <td>15</td>
        <td>MADDPG</td>
        <td><a href="https://paperswithcode.com/paper/multi-agent-actor-critic-for-mixed">Multi-Agent Actor-Cri</br>tic for Mixed Cooperative-Competitive Environments</a></td>
    ...
    <tr>
        <td>16</td>
        <td>AlphaZero</td>
        <td><a href="无">Learning to Play Othe</br>llo Without Human Knowledge</a></td>
    ...
    <tr>
        <td>17</td>
        <td>CARLA_SAC</td>
        <td><a href="同 SAC">Soft Actor-Critic: Of</br>f-Policy Maximum Entropy Deep Reinforcement Learning with a Stochastic Actor</a></td>
    ...
    <tr>
        ...
        <td><a href="https://paperswithcode.com/paper/action-set-based-policy-optimization-for-safe">Action Set Based Poli</br>cy Optimization for Safe Power Grid Management</a></td>
    ...
    <tr>
        <td>19</td>
        <td>OAC</td>
        <td><a href="https://paperswithcode.com/paper/better-exploration-with-optimistic-actor-1">Better Exploration wi</br>th Optimistic Actor-Critic</a></td>
    ...
    <tr>
        <td>20</td>
        <td>QMIX</td>
        <td><a href="https://paperswithcode.com/paper/the-starcraft-multi-agent-challenge">The StarCraft Multi-A</br>gent Challenge</a></td>
...
<table>
    ...
    <tr>
        <td>1</td>
        <td>GaAN</td>
        <td><a href="https://paperswithcode.com/paper/gaan-gated-attention-networks-for-learning-on#code">GaAN: Gated Attention</br> Networks for Learning on Large and Spatiotemporal Graphs</a></td>
    ...
    <tr>
        <td>2</td>
        <td>stgcn</td>
        <td><a href="https://paperswithcode.com/paper/spatio-temporal-graph-convolutional-networks">Spatio-Temporal Graph</br> Convolutional Networks: A Deep Learning Framework for Traffic Forecasting</a></td>
    ...
    <tr>
        <td>3</td>
        <td>graphsage</td>
        <td><a href="https://paperswithcode.com/paper/inductive-representation-learning-on-large">Inductive Representat</br>ion Learning on Large Graphs</a></td>
    ...
    <tr>
        <td>4</td>
        <td>metapath2vec</td>
        <td><a href="https://paperswithcode.com/paper/metapath2vec-scalable-representation-learning">metapath2vec: Scalabl</br>e Representation Learning for Heterogeneous Networks</a></td>
    ...
    <tr>
        <td>6</td>
        <td>line</td>
        <td><a href="https://paperswithcode.com/paper/line-large-scale-information-network">LINE: Large-scale Inf</br>ormation Network Embedding</a></td>
    ...
    <tr>
        <td>11</td>
        <td>sgc</td>
        <td><a href="https://paperswithcode.com/paper/simplifying-graph-convolutional-networks">Simplifying Graph Con</br>volutional Networks</a></td>
    ...
    <tr>
        <td>12</td>
        <td>gcn</td>
        <td><a href="https://paperswithcode.com/method/gcn">Semi-Supervised Class</br>ification with Graph Convolutional Networks</a></td>
    ...
    <tr>
        <td>13</td>
        <td>gin</td>
        <td><a href="https://paperswithcode.com/paper/how-powerful-are-graph-neural-networks">How Powerful are Grap</br>h Neural Networks?</a></td>
    ...
    <tr>
        <td>14</td>
        <td>strucvec</td>
        <td><a href="https://paperswithcode.com/paper/struc2vec-learning-node-representations-from">struc2vec: Learning N</br>ode Representations from Structural Identity</a></td>
    ...
    <tr>
        <td>15</td>
        <td>node2vec</td>
        <td><a href="https://paperswithcode.com/paper/node2vec-scalable-feature-learning-for">node2vec: Scalable Fe</br>ature Learning for Networks</a></td>
    ...
    <tr>
        <td>16</td>
        <td>GATNE</td>
        <td><a href="https://paperswithcode.com/paper/190501669">Representation Learni</br>ng for Attributed Multiplex Heterogeneous Network</a></td>
    ...
    <tr>
        <td>17</td>
        <td>deeper_gcn</td>
        <td><a href="无">DeeperGCN: All You Ne</br>ed to Train Deeper GCNs</a></td>
    ...
    <tr>
        <td>18</td>
        <td>ges</td>
        <td><a href="https://paperswithcode.com/paper/billion-scale-commodity-embedding-for-e">Billion-scale Commodi</br>ty Embedding for E-commerce Recommendation in Alibaba</a></td>
    ...
    <tr>
        <td>21</td>
        <td>MAG240M</td>
        <td><a href="https://paperswithcode.com/paper/masked-label-prediction-unified-massage">Masked Label Predicti</br>on: Unified Message Passing Model for Semi-Supervised Classification</a></td>
    ...
    <tr>
        <td>24</td>
        <td>lightgcn</td>
        <td><a href="https://paperswithcode.com/paper/lightgcn-simplifying-and-powering-graph">LightGCN: Simplifying</br> and Powering Graph Convolution Network for Recommendation</a></td>
    ...
    <tr>
        <td>25</td>
        <td>ngcf</td>
        <td><a href="https://paperswithcode.com/paper/neural-graph-collaborative-filtering">Neural Graph Collabor</br>ative Filtering</a></td>
    ...
    <tr>
        <td>26</td>
        <td>rgcn</td>
        <td><a href="https://paperswithcode.com/paper/modeling-relational-data-with-graph">Modeling Relational D</br>ata with Graph Convolutional Networks</a></td>
    ...
    <tr>
        <td>27</td>
        <td>ssgc</td>
        <td><a href="https://paperswithcode.com/paper/simple-spectral-graph-convolution">Simple Spectral Graph</br> Convolution</a></td>
