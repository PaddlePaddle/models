## Introduction
Sequence is an input data type faced by many machine learning and data mining tasks. Taking Natural Language Processing task as an example, sentences are composed of words, while multiple sentences form a paragraph further. As a result, a paragraph can be seen as a nested sequence (or called a double sequence), and each element of the sequence is a sequence.
