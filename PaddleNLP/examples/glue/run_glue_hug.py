...
from paddlenlp.datasets import GlueCoLA, GlueSST2, GlueMRPC, GlueSTSB, GlueQQP, GlueMNLI, GlueQNLI, GlueRTE, MapDatasetWrapper
...
def do_train(args):
    ...
    train_dataset = MapDatasetWrapper(glue_dataset['train'])
    ...
    if args.task_name == "mnli":
        ...
        dev_dataset = MapDatasetWrapper(glue_dataset['validation'])
    ...
    num_classes = len(glue_dataset["train"].features["label"].names)
