...
mem_settings_g.add_arg('retrieved_synset_path',   str,    'concept_resources/wordnet_concepts_squad/retrived_synsets.data',   'path of retrieved synsets')
mem_settings_g.add_arg('use_nell',                bool,   False,  'whether to use nell memory')
mem_settings_g.add_arg('train_retrieved_nell_concept_path',   str,    'concept_resources/nell_concepts_squad/train.retrieved_nell_concepts.data', 'path of retrieved concepts for trainset')
mem_settings_g.add_arg('dev_retrieved_nell_concept_path',     str,    'concept_resources/nell_concepts_squad/dev.retrieved_nell_concepts.data',   'path of retrieved concepts for devset')
...
def train(args):
    ...
    if args.do_train:
        train_concept_settings = {
            'tokenization_path': 'concept_resources/tokenize_result_squad/train.tokenization.{}.data'.format('uncased' if args.do_lower_case else 'cased'),
    ...
    if args.do_predict or args.do_val:
        eval_concept_settings = {
            'tokenization_path': 'concept_resources/tokenize_result_squad/dev.tokenization.{}.data'.format('uncased' if args.do_lower_case else 'cased'),
            'wn_concept2id': wn_concept2id,
            'nell_concept2id': nell_concept2id,
            'use_wordnet': args.use_wordnet,
            'retrieved_synset_path': args.retrieved_synset_path,
