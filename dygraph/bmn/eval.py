...
def test_bmn(args):   
    ...
    with fluid.dygraph.guard(place):
        ...
        for batch_id, data in enumerate(test_reader()):
            ...
            gen_props(pred_bm, pred_start, pred_end, video_idx, video_list, test_config, mode='test')
        ...
        bmn_post_processing(video_dict, test_config.TEST.subset, test_config.TEST.output_path, test_config.TEST.result_path)
