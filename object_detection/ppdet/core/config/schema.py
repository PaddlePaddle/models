...
class SchemaDict(dict):
    ...
    def find_default_keys(self):
        return [k for k in list(self.keys()) + list(self.schema.keys())
    ...
    def find_missing_keys(self):
        missing = [k for k in self.schema.keys()
...
def extract_schema(cls):
    ...
    schema.category = hasattr(cls, '__category__') and getattr(cls, '__category__') or 'module'
