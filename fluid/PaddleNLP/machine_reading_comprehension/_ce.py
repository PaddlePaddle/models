...
train_cost_card4_kpi = CostKpi('train_cost_card2', 0.01, 0, actived=True)
test_cost_card4_kpi = CostKpi('test_cost_card2', 0.005, 0, actived=True)
train_duration_card4_kpi = DurationKpi(
    'train_duration_card2', 0.06, 0, actived=True)
