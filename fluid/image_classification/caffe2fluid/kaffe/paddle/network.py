...
class Network(object):
    ...
    def conv(self,
        ...
        fluid = import_fluid()
        padding = [calc_padding(h_i, k_h, s_h, type=padding), \
                    calc_padding(w_i, k_w, s_w, type=padding)]
    ...
    def avg_pool(self, input, k_h, k_w, s_h, s_w, name,
        ...
        output = fluid.layers.pool2d(
            input=input,
            pool_size=[1, k_h, k_w, 1],
            pool_stride=[1, s_h, s_w, 1],
            pool_type='avg')
        return output
