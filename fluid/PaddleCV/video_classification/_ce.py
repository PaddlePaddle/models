...
train_acc1_card1_kpi = CostKpi('train_acc1_card1', 0.08, 0)
train_acc5_card1_kpi = CostKpi('train_acc5_card1', 0.08, 0)
...
train_acc1_card4_kpi = CostKpi('train_acc1_card4', 0.08, 0)
train_acc5_card4_kpi = CostKpi('train_acc5_card4', 0.08, 0)
...
train_acc1_card8_kpi = CostKpi('train_acc1_card8', 0.08, 0)
train_acc5_card8_kpi = CostKpi('train_acc5_card8', 0.08, 0)

tracking_kpis = [
        each_pass_duration_card1_kpi,
        train_loss_card1_kpi,
        train_acc1_card1_kpi,
        train_acc5_card1_kpi,
        each_pass_duration_card4_kpi,
        train_loss_card4_kpi,
        train_acc1_card4_kpi,
        train_acc5_card4_kpi,
        each_pass_duration_card8_kpi,
        train_loss_card8_kpi,
        train_acc1_card8_kpi,
        train_acc5_card8_kpi,
        ]
