...
def load_list():
    ...
    lFeature = open("/home/disk2/mini_speech_fbank_40/data/feature.lst").readlines()
    lLabel = open("/home/disk2/mini_speech_fbank_40/data/label.lst").readlines()
