...
def infer(args):
    ...
    # yapf: enable
    infer_reader = reader.infer(args)
    ...
    path = os.path.join(args.image_path, args.image_name)
    draw_bounding_box_on_image(path, nmsed_out, args.draw_threshold, label_list)
